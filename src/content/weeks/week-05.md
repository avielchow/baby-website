...
todos:
  - title: "Build tummy time toward 15–30 minutes a day"
    ...
    sources:
      ...
      - { label: "CDC", url: "https://www.cdc.gov/act-early/milestones/2-months.html" }
    video:
      title: "How, When, and Where to Start Tummy Time with a Newborn | Pediatric Therapist Approved Video"
...
feeding:
  - title: "A growth spurt may hit around 6 weeks — expect cluster feeding"
    detail: "Right about now, or in the next week or two, many babies hit a growth spurt: a day or two of a hungrier, fussier baby who wants to feed almost constantly, sometimes every hour in the evening — that bunched-up marathon is called cluster feeding. It looks alarming but it's the system working exactly as designed: the extra demand is the signal that tells your body to make more milk, and it typically settles within a couple of days. Ride it out by feeding on cue, parking yourself somewhere comfortable with water and snacks, and not reaching for a 'top-up' bottle out of panic. A formula-fed baby may just take a little more per bottle for a few days. It is not a sign your supply is failing."
    sources:
  ...
  - title: "If feeding still hurts or feels shaky, get help now"
    detail: "Persistent pain, cracked nipples, worries about weight gain, or a knot of dread before feeds are fixable problems — and the fix is easier at five weeks than at ten. Ask your clinic or public health nurse for a lactation consultant referral, call Health Link 811 any hour, or reach a La Leche League leader for free breastfeeding support. 'It technically works but I dread it' is a completely valid reason to call — you don't have to earn help by suffering more first."
    sources:
      - { label: "LLLI", url: "https://llli.org/breastfeeding-info/frequency-feeding-frequently-asked-questions-faqs/" }
      - { label: "Nemours", url: "https://kidshealth.org/en/parents/feed13m.html" }
sleep:
  - title: "Maybe one slightly longer stretch — still no real schedule"
    detail: "Babies this age sleep about 14–17 hours across a 24-hour day, and some are starting to offer one longer run at night around now — though 'sleeping through' at this age officially means only a 5–6 hour stretch, and even that is months away for many. Plenty of five-week-olds still have day and night partly scrambled, which is completely normal. Keep nudging the rhythm along: days bright, loud, and social; nights dark, quiet, and boring, with feeds kept low-key and dull. It builds over the coming months, not this week — don't chase a schedule yet."
    sources:
...
redFlags:
  - title: "Fever is still an emergency at this age"
    detail: "Any fever in a baby under 3 months — a rectal temperature of 38.0°C (100.4°F) or higher — means immediate medical care, exactly as it did in week one; this rule does not relax for a while yet. A rectal reading is the accurate method at this age, so keep a digital thermometer on hand and know the technique before you need it at 2 a.m. Don't give fever medicine and wait to see how it goes — a young baby with a fever needs to be seen, now."
    sources:
  ...
  - title: "Baby blues that haven't lifted, or feeling hopeless — in either parent"
    detail: "The blues fade within a couple of weeks of birth; sadness, hopelessness, losing pleasure in things, constant anxiety or panic, or trouble bonding that drags on past that is postpartum depression or anxiety territory — it affects roughly 1 in 7 to 1 in 8 new mothers, partners can develop it too, and both are very treatable. Call your family doctor or Health Link 811, and expect mood questions at the postpartum checkup (often the 10-question Edinburgh scale) — being asked isn't an accusation, it's the system doing its job. Thoughts of harming yourself or the baby mean call 911 or the 988 suicide crisis line now, not later."
    sources:
...
alsoWorthKnowing:
  - title: "You're near the top of the crying curve — it's a curve, not a verdict"
    ...
    sources:
      ...
      - { label: "CPS", url: "https://caringforkids.cps.ca/handouts/pregnancy-and-babies/colic_and_crying" }
    video:
      title: "The Period of Purple Crying - A New Way to Understand Your Baby's Crying"
  ...
  - title: "Talk back to the coos — turn-taking is how language starts"
    ...
    sources:
      - { label: "AAP", url: "https://www.healthychildren.org/English/ages-stages/baby/Pages/Hearing-and-Making-Sounds.aspx" }
      - { label: "Nemours", url: "https://kidshealth.org/en/parents/learn13m.html" }
  - title: "Parent tip: guard one protected sleep block each"
    detail: "If there are two of you, assign each parent one guarded 3–4 hour sleep block a day — earplugs in, door shut, fully off duty, no listening with one ear. Around the crying peak, sleep is the cheapest and most effective mental-health tool you have, and relentless broken sleep is one of the things that feeds postpartum depression and anxiety in both parents. Treat the block like a shift you're scheduled for: it isn't selfish, it's maintenance on the only two people running this operation."
    sources:
      - { label: "AHS", url: "https://myhealth.alberta.ca/Health/pages/conditions.aspx?hwid=tn9653" }
      - { label: "CPS", url: "https://caringforkids.cps.ca/handouts/pregnancy-and-babies/depression_in_pregnant_women_and_mothers" }
  ...
  - item: "Activity gym / play mat"
    ...
    brands:
      - name: "Lovevery Play Gym"
        ...
        pros:
          - "Stage-based activities and cards that change with development through the first year"
          - "Thick, quality mat with a wooden batting toy and a black-and-white early-months set"
          - "Converts to a little play space later with the add-on cover"
        cons:
          - "Expensive — well above most gyms"
          - "Assembly and toy-swapping take a bit more effort than a fixed gym"
          - "Ships direct/select retailers rather than being on every shelf"
      - name: "Fisher-Price Kick & Play Piano Gym"
        note: "The affordable, everywhere-available classic; the piano panel adds lights and sound and later moves to the crib or floor as a standalone toy."
        url: "https://www.fisher-price.com/en-ca/product/deluxe-kick-play-piano-gym-dyw49"
        pros:
          - "Inexpensive and stocked at nearly every Canadian baby retailer"
          - "Kick-activated piano grows with baby from lying under it to sitting and playing"
          - "Removable, washable arches and toys"
        cons:
          - "Lights-and-sound electronics feel busier than a calm Montessori setup"
          - "Thinner mat than premium gyms — a folded blanket underneath helps"
          - "Batteries required for the piano panel"
      - name: "IKEA (KLAPPA / GULLIGAST)"
        note: "The budget pick: simple, inoffensive baby gyms at a low price, good if you want something functional without the spend."
        url: "https://www.ikea.com/ca/en/cat/baby-gyms-27812/"
        pros:
          - "Very low price and widely available across Canada"
          - "Simple, sturdy, no electronics to fail or annoy"
          - "Easy to wipe down and fold away"
        cons:
          - "Thin mat — use it over a rug or blanket"
          - "Fewer developmental bells and whistles than pricier gyms"
          - "Specific models come and go, so stock varies by store"
    video:
      title: "How to Set Up The Play Gym by Lovevery"
      url: "https://www.youtube.com/watch?v=VeaMvY2X7q8"
      channel: "Lovevery"
    sources:
      - { label: "AAP", url: "https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/back-to-sleep-tummy-to-play.aspx" }
      - { label: "Nemours", url: "https://kidshealth.org/en/parents/learn13m.html" }
  - item: "Pacifier (if you're using one)"
    ...
    brands:
      - name: "Philips Avent Soothie"
        ...
        url: "https://www.usa.philips.com/c-p/SCF190_41/avent"
        pros:
          - "Single piece of medical-grade silicone — nothing to detach, easy to sterilise"
          - "Familiar hospital shape many babies accept readily"
          - "Cheap and sold nearly everywhere in Canada"
        cons:
          - "Bulky, flat shield some babies push out"
          - "Plain design with no glow or handle on the basic version"
          - "Not orthodontic-shaped like some competitors"
      - name: "MAM (Original / Air)"
        note: "Orthodontic-style nipple with a curved, vented shield many parents find gentler on the skin; comes with a clever self-sterilising case."
        url: "https://www.mambaby.com/en-us/shop/pacifiers/"
        pros:
          - "Vented, curved shield reduces pressure marks on the cheeks"
          - "Symmetrical orthodontic nipple that goes in either way up"
          - "Sterilise-in-the-case feature is handy for travel"
        cons:
          - "Multi-part build has more nooks than a one-piece and can trap moisture"
          - "Some breastfed babies reject the flatter nipple shape"
          - "Pricier per soother than a plain Soothie"
      - name: "BIBS"
        note: "The round-nipple Danish soother (the cerpop-style favourite); a natural, rounded shape and a huge colour range, widely stocked in Canada."
        url: "https://bibsworld.com/en-ca/collections/pacifiers"
        pros:
          - "Rounded nipple mimics a bottle/breast shape many newborns take to"
          - "Natural rubber and silicone options, in lots of sizes and colours"
          - "One-piece build, easy to clean"
        cons:
          - "Round (non-orthodontic) shape isn't every dentist's preference for older babies"
          - "Natural rubber wears faster and needs more frequent replacing"
          - "Style-driven range means it's easy to over-buy on looks"
    sources:
      - { label: "CPS", url: "https://caringforkids.cps.ca/handouts/pregnancy-and-babies/pacifiers" }
      - { label: "AAP", url: "https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/A-Parents-Guide-to-Safe-Sleep.aspx" }
sources:
  ...
  - label: "AAP HealthyChildren — Hearing and Making Sounds: Your Baby's Milestones"
