...
mood: "close, quiet, studied, tactile — a film you can almost feel on your palm"
runtime: "~90 seconds"
...
shots:
  - n: 1
    ...
    settings: >-
      4K24 in APS-C crop mode (the honest macro trick: the 85mm's minimum
      focus distance is about 0.8m at roughly 0.13x magnification, so at
      closest focus a whole hand plus wrist is only a third of the
      full-width frame — the S35 crop reframes it to ~128mm-equivalent
      from the same 0.8m without moving inside the lens's limit, and the
      crop is still oversampled so nothing is faked). 1/50, S-Log3, f/2.8
      for a few millimetres of depth at this magnification, ISO 800, WB
    ...
    lighting: >-
      ...
      edge, bouncing window light back up into the palm. No sticks — the
      shot is a negotiation between one window and one bounce, and the
    ...
    direction: >-
      Shoot in a calm alert window mid-morning — fed, dry, happy on the
      mat. Nine-week-olds genuinely do this unprompted: wait for the fist
      to rise into the light and roll long. Three minutes of footage
      for five usable seconds is the exchange rate; take it.
    diagram:
      room: { w: 4, h: 3 }
      ...
      note: "Room box = the play-gym mat by the window. Mark tripod feet for Shot 15."
  - n: 2
    name: "The fist study"
    purpose: >-
    ...
    gear: "a7CII + 85mm on tripod, follow-focus ring mounted"
    settings: >-
      4K24 full-width, 1/50, S-Log3, f/2 so the pull between fist and
    ...
    movement: >-
      ...
      between the tape marks over about 6 seconds, pause 2, return.
      Three takes maximum — the rack has to feel like attention
      shifting, not a demo of the follow-focus ring.
    direction: >-
    ...
    diagram:
      ...
      note: "Tape marks on the ring: FIST / EYES. Rehearse on your own knuckle first."
  - n: 3
    name: "Batting practice"
    purpose: >-
      The workout montage source: under the play gym, swinging at the
      dangler and missing, missing, grazing, missing. The clumsiness IS
      the story — this is what learning looks like before it works, and
      the edit will cut three misses ahead of Shot 4's connection.
    ...
    lighting: >-
      Play gym in its usual spot near the window, light from the side so
      the swinging arm throws a small moving shadow across the mat —
      free visual rhythm. No added lights: the gym's arch would turn any
      backlight into flare and any stand nearby is a stand too close to
      a kicking baby.
    movement: >-
    ...
    direction: >-
      Roll 10-minute takes across two or three play sessions this week.
      Wind the swings up by giving the dangler one gentle push as you
      leave frame. Keep every miss — the edit needs at least three
  ...
  - n: 4
    ...
    settings: >-
      4K60 for slow motion (note the crop: 60p is APS-C, so the 85mm
      frames like ~128mm — set up noticeably further back than Shot 1
    ...
    lighting: >-
      ...
      scene. The extra stop the shutter takes is why this shot shoots
      in the brightest window of the day, not why a light gets added.
    movement: >-
    ...
    diagram:
      room: { w: 4, h: 3 }
      window: { wall: left, from: 0.25, to: 0.7 }
      subject: { x: 0.45, y: 0.4, label: "Dangler + incoming hand" }
      camera: { x: 0.8, y: 0.75, facing: 307, label: "a7CII · 85mm (~128mm in 60p crop)" }
      note: "Match Shot 3's light exactly — misses and hit must cut as one scene."
  - n: 5
    name: "Hand to mouth"
    purpose: >-
      The new self-soothing, and the week's quiet revolution: after
      days of near-misses the hand now finds the mouth on purpose, and
      the fussing... stops. Shot warm and close at dusk — this is the
      crying easing, told without showing crying.
    gear: "a7CII + 85mm on tripod"
    settings: >-
    ...
    movement: >-
      Locked off, close: frame from lips to wrist and let the room fall
      away. The event is small — fingers finding the mouth, the jaw
    ...
    diagram:
      room: { w: 4, h: 4 }
      window: { wall: bottom, from: 0.3, to: 0.75 }
      subject: { x: 0.4, y: 0.4, label: "Baby in glider, hand to mouth" }
      camera: { x: 0.75, y: 0.75, facing: 315, label: "a7CII · 85mm" }
      lights:
        - { x: 0.2, y: 0.25, kind: practical, label: "Floor lamp · 3200K key" }
        - { x: 0.26, y: 0.31, kind: stick, label: "Stick A · 3200K floor, behind lamp base" }
      note: "Warm lamp key, cool dying window behind — the film's one dusk frame."
  - n: 6
    name: "The choice"
    purpose: >-
    ...
    diagram:
      ...
      lights:
        - { x: 0.12, y: 0.3, kind: reflector, label: "Board vs wall — shadow-side fill" }
      note: "Room box = changing-table area. Camera beside, never over, the table."
  - n: 7
    ...
    gear: "a7CII + 85mm on tripod"
    settings: >-
      4K24 in APS-C crop mode (same 0.8m minimum-focus honesty as
      Shot 1 — fill the frame with two hands by cropping, not by
      creeping inside the lens's limit and hunting), 1/50, S-Log3,
      f/4 this once: both hands must be sharp together, because
      softness would blur the size comparison that IS the shot.
      ISO 800 ceiling 3200, WB locked 5600K.
    lighting: >-
      Couch by the window, hands in the soft top-light falling past
      the window frame. Flat-ish light is correct here — this frame is
      a measurement, and raking drama would fight the plainness that
      makes it land. No sticks, no bounce: window and skin.
    movement: >-
      Locked off, straight-on and level with the hands. Hold at least
  ...
  - n: 8
    ...
    gear: "a7CII + 85mm on tripod"
    settings: >-
      4K24 full-width, 1/50, S-Log3, f/2 — this frame wants the soft
    ...
    lighting: >-
      ...
      same light, eight weeks later, and now there's a fist that
      holds back. No sticks near a feeding chair; the foam board on
      the floor opens the shadow side if needed.
    movement: >-
      Locked off. Set the frame during the pre-feed fuss — hands and
      bottle only, faces out of frame — hit record, and go away for
      twenty minutes. The micro-drama of fingers flexing and
      regripping is the entire shot.
    direction: >-
      Zero direction once the feed starts; the thumb-grab happens by
      itself now, most feeds. Frame loose enough to survive position
      shifts. If this feed isn't the one, the next one is two-and-a-
      half hours away.
    diagram:
      room: { w: 4, h: 4 }
      window: { wall: left, from: 0.2, to: 0.7 }
      ...
      note: "Week 1's feed corner, revisited on purpose — now with a grip in it."
  - n: 9
    ...
    purpose: >-
      ...
      with a smile.
    gear: "a7CII + 85mm on tripod (long, from across the room)"
    settings: >-
      4K24, 1/50, S-Log3, f/2 for the compressed, creamy long-lens
      look, ISO 800 ceiling 3200 (cats choose their own hour), WB
      locked to the dominant source — 5600K day, 3200K lamps. Manual
      focus on the point where hand meets fur; the 85mm from 2.5m
      keeps you far enough away that neither cat nor baby clocks the
      camera.
    lighting: >-
      Wherever the cat has parked — realistically the sofa's window
      end. Available light only: a stand anywhere near this
      negotiation is a stand that gets knocked, and the shot's charm
      is documentary, not designed.
    movement: >-
    ...
    direction: >-
      ...
      after its dinner. Two gentle strokes and done; end the scene
      before the cat does.
    diagram:
      room: { w: 5, h: 4 }
  ...
  - n: 10
    ...
    settings: >-
      4K24, 1/50 locked in Pro mode, D-Log M 10-bit, auto-ISO capped
      1600, WB locked 5600K to the kitchen window, focus locked
      centre-fixed on the bottle zone so it doesn't hunt between hands.
      The Pocket 3 gets this one because it can sit INSIDE the
      counter clutter at bottle height, where the a7CII would need a
      tripod in the workspace.
    lighting: >-
      Kitchen window as key; under-cabinet practicals on if the day is
      grey. No sticks in a splash zone. Shoot the real morning bottle
      routine — the light the kitchen actually has at 7am is the
      light this shot is about.
    movement: >-
      Static, low, close — bottle-cap height, hands entering and
      leaving frame. In the edit this cuts at double the film's usual
      tempo (1.5–2 seconds per beat), so shoot each action from ONE
      angle cleanly rather than covering everything loosely.
    direction: >-
      No staging: record three real prep sessions and harvest. Hands
      only, no faces — anonymity makes the hands stand for every
      parent who ever did this at dawn.
    diagram:
      room: { w: 4, h: 3 }
      window: { wall: top, from: 0.3, to: 0.75 }
      subject: { x: 0.5, y: 0.3, label: "Hands + bottles at counter" }
      camera: { x: 0.5, y: 0.75, facing: 0, label: "Pocket 3 · counter level" }
      lights:
        - { x: 0.15, y: 0.2, kind: practical, label: "Under-cabinet strip (grey days)" }
      note: "Room box = kitchen counter run. Camera lives among the bottles."
  - n: 11
    name: "The hands of the house II: laundry"
    purpose: >-
      Triptych beat two: folding impossibly small clothes on the bed —
      a direct echo of week one's dresser shot, except the stacks are
      now in constant circulation and the hands fold on autopilot.
      Care, rendered as repetition.
    gear: "a7CII + 50mm on RS3 Mini"
    settings: >-
      4K24, 1/50, S-Log3, f/2 so sleeves melt in and out of the
      plane, ISO 800 ceiling 1600, WB locked 5600K. Manual focus
      fixed at the folding zone — the slide provides the parallax,
      no pulling.
    lighting: >-
      Bedroom window raking from camera-right across the folds and
      knuckles. No sticks; laundry light should look like laundry
      light. If the basket side of frame goes muddy, a white pillow
      propped beyond it is the house's own reflector.
    movement: >-
      RS3 Mini in Lock mode: a 40cm lateral slide along the bed's
      edge, weight-shift lunge rather than steps, camera square to
      the bed. The identical move to week one Shot 2, on purpose —
    ...
    diagram:
      room: { w: 5, h: 4 }
      window: { wall: right, from: 0.2, to: 0.65 }
      subject: { x: 0.5, y: 0.4, label: "Basket + tiny clothes on bed" }
      camera: { x: 0.4, y: 0.75, facing: 20, label: "a7CII · 50mm on RS3" }
      move:
        type: slide
        path: [{ x: 0.25, y: 0.75 }, { x: 0.55, y: 0.75 }]
        label: "RS3 Lock: 40cm slide, square to the bed"
      note: "Week 1 Shot 2's move, one floor up and eight weeks in."
  - n: 12
    ...
    movement: >-
      ...
      meaning. Roll five minutes; the shot's event is one email's
  ...
  - n: 13
    ...
    settings: >-
      ...
      against the darker tub side; let the window edge clip softly
      if it wants to.
    lighting: >-
    ...
    movement: >-
      Handheld, elbows braced on ribs, drifting centimetres — a
      parent's-eye view of a parent's-hands job. One operator films
      while the other baths; the bath owns both of the bather's
      hands anyway.
    direction: >-
  ...
  - n: 14
    ...
    direction: >-
      ...
      sack only, the swaddle folded in the drawer at frame's edge if
      it wants a cameo. The midline lacing is luck multiplied by
      nights: leave the camera rolling during the settled stretch
      after the dream feed, two or three nights this week. Safe sleep
      on show throughout — back, bare crib, sack and nothing else.
    diagram:
      room: { w: 5, h: 4 }
      window: { wall: right, from: 0.2, to: 0.7 }
      subject: { x: 0.55, y: 0.35, label: "Crib — hands laced at midline" }
      subject2: { x: 0.3, y: 0.55, label: "Changing table — the first zip" }
      camera: { x: 0.55, y: 0.8, facing: 0, label: "a7CII · 85mm, rail height, outside the rail" }
      lights:
        - { x: 0.85, y: 0.15, kind: practical, label: "Night light · 2700K, only source" }
      note: "Nothing in or over the crib; camera an arm's length outside the rail."
  - n: 15
    ...
    settings: >-
      ...
      ring like Shot 2.
    lighting: >-
      Shot 1's setup re-rigged from your notes: window behind as
      backlight, foam board flat on the mat bouncing fill into the
      grip. Same time of morning, same tripod marks. The rhyme only
      lands if the light matches — this is the one shot this week
      worth rescheduling for weather.
    movement: >-
      Locked off with the single rehearsed focus pull. Hold the end
      frame at least 10 seconds after the pull settles: the edit
      fades to black from inside this stillness, and every frame you
    ...
    diagram:
      room: { w: 4, h: 3 }
      window: { wall: top, from: 0.2, to: 0.7 }
      subject: { x: 0.45, y: 0.35, label: "Both hands on one finger" }
      subject2: { x: 0.65, y: 0.55, label: "Parent kneeling beside the mat" }
      camera: { x: 0.45, y: 0.8, facing: 0, label: "a7CII · 85mm — Shot 1's marks" }
      lights:
        - { x: 0.45, y: 0.58, kind: reflector, label: "White board flat on mat — same bounce" }
      note: "Shot 1's frame, answered. Match light, marks, and morning."
edit:
  timeline:
    - >-
      Project setup: new project "Week 9 — Hands", timeline 3840x2160 at
      23.976, DaVinci YRGB (manual CSTs as always). Bin by shot number
      01–15 with the Shot 3 batting selects in their own sub-bin — you'll
      have twenty minutes of misses to mine and the sub-bin keeps the
      hunt sane.
    - >-
      Interpret the Shot 4 60p clip: Clip Attributes → 23.976 for a clean
      40% conform — the hit plays at dream speed with no Retime FX.
      Remember it carries the APS-C crop: check it against the
      full-width Shot 3 material for any framing jump and punch Shot 3
      a few percent if the two need to marry tighter.
    - >-
      Assembly in five movements: DISCOVERY (1, 2) → PRACTICE (3, 4, 5)
      → THE CHOICE (6) → SCALE (7, 8, 9) → THE HOUSE'S HANDS (10, 11,
      12) then EASE (13, 14, 15). Shot 6 stands alone as its own
      movement on purpose — it's the hinge, give it silence and room.
    - >-
      The batting sequence is the film's one editing set piece: three
      misses from Shot 3 at normal speed, each cut slightly shorter
      than the last (2.5s, 2s, 1.5s — a compressing rhythm of effort),
      then the Shot 4 slow-motion connection running a full 6 seconds.
      Cut the misses on the arm's downswing so each failure hands
      momentum to the next attempt.
    - >-
      Punch-in policy for the macro material: the oversampled 4K holds
      a 110–130% post punch cleanly for reframing shots 1, 2, and 15 —
      beyond that it's upscale, so if a frame needs more, it needed
      the S35 crop on the day. Never digital-zoom the Shot 4 crop
      material; it has no headroom left.
    - >-
      The HOUSE'S HANDS triptych (10, 11, 12) runs at double tempo:
      1.5–2 seconds per beat, hard cuts, six to eight beats total,
      then Shot 12 holds long as the tempo collapses back into the
      film's true pace — the fast hands slowing into the one-handed
      typing frame is the sequence's sentence structure.
    - >-
      Trim philosophy everywhere else: long holds, cut on stillness.
      Shots 7 and 15 earn their full length — 8 and 10+ seconds. If
      the fist-study rack (Shot 2) feels slow, it's working.
    - >-
      Transitions: straight cuts only, three exceptions — 24-frame fade
      from black into Shot 1, a 24-frame dissolve from the Shot 13
      water into Shot 14's night (warm water into warm dark), and a
      48-frame fade to black out of Shot 15, slower than week one's
      ending because this film ends mid-grip.
    - >-
      Title: over the back half of Shot 1, "HANDS" in the series serif
    ...
    - >-
      ...
      phrase-end — the music noticing the hit a beat late reads as
      surprise, which is truer than a stinger.
    - >-
      Watch twice — once with sound, once muted — then deliver: H.265
      10-bit 4K master ~80 Mbps for the archive, H.264 4K for the
      unlisted YouTube upload; drop the link into videoUrl when live.
  gradeNodes:
    - n: 1
      name: "CST In"
      what: >-
        Color Space Transform: S-Gamut3.Cine / S-Log3 → DaVinci Wide
        Gamut / DaVinci Intermediate, tone mapping None. The Pocket 3
        bottle material gets its own CST (DJI D-Gamut / D-Log M in)
        via a group, so all fifteen shots enter the tree speaking one
        language.
    - n: 2
      name: "Balance"
      what: >-
        Offset-match exposure so skin — and this film is 90% skin —
        sits 55–65 IRE shot to shot. Keep three deliberate exceptions
        darker: the dusk hand-to-mouth (Shot 5), the desk (Shot 12),
        and the night crib (Shot 14) hold their lamp-lit levels; the
        film's day/dusk/night structure lives in this node.
    - n: 3
      name: "Filmic contrast"
      what: >-
        The series S-curve: low-mids eased down, soft highlight
        shoulder, black point lifted ~0.02 to milk. Mind the backlit
        shots (1, 15): the shoulder must keep the translucent finger-
        edge glow from clipping to paper — roll it off until the rim
        stays red-warm, not white.
    - n: 4
      name: "Split tone"
      what: >-
        Log wheels: highlights toward warm amber, shadows toward teal,
        both small — the series signature. Check the vectorscope
        skin-tone line hard on this film: with frames that are all
        hands, a split-tone overreach reads instantly as seasick skin.
    - n: 5
      name: "Skin protect"
      what: >-
        Qualify skin, soften the matte, and inside it restore the
        saturation the split tone stole and nudge hue to natural.
        Nine-week-old hands run mottled pink-purple when cool — a
        gentle Hue vs Hue of magenta-reds toward peach evens them
        without waxing them; adult hands in the scale shots keep
        their texture, so feather the matte off the parent skin
        rather than smoothing everyone into the same hand.
    - n: 6
      name: "Halation"
      what: >-
        Parallel node: qualify only the hottest highlights — the
        backlit window in Shots 1/15, ripple-glints in Shot 13, lamp
        cores — blur the matte heavily, tint warm-red, Screen at
        10–15%. On the backlit finger shots this is the node doing
        the "memory glow"; if fingers start blooming like neon, pull
        the qualifier tighter, not the opacity lower.
    - n: 7
      name: "Grain"
      what: >-
        ResolveFX Film Grain (Studio), 35mm preset, size ~0.6, opacity
        ~0.3 — or the free-version overlay-clip method on a top track.
        Grain matters double on macro skin: it breaks up the digital
        smoothness that makes close-up flesh look rendered. After
        halation, before the output CST.
    - n: 8
      name: "Vignette"
      what: >-
        Circular Power Window, inverted, softness 0.7+, Gain ~0.9
        outside — but on this film keep it OFF the tightest macro
        frames (1, 2, 15), which vignette themselves with falloff;
        apply it only to the roomier frames (3, 9, 11) where the eye
        needs herding.
    - n: 9
      name: "CST Out"
      what: >-
        DaVinci Wide Gamut / Intermediate → Rec.709 / Gamma 2.4,
        DaVinci tone mapping, Forward OOTF on. Grade at 2.4 in a dim
        room, then sanity-check on a phone — where thumbnail-sized
        hands must still read as hands, which is the real test of
        every framing choice this week.
  sound:
    - >-
      Room tone: 30 seconds each of the play-mat corner, the kitchen,
      and the nursery at night. The mat-corner tone beds the whole
      film; the nursery tone takes over for Shot 14.
    - >-
      This film's featured real sound is TOUCH: the dangler's rattle
      on the Shot 4 hit (played at 100% speed against the 40% picture
      — the mismatch is dreamlike and correct), the bath water in
      Shot 13, the keyboard in Shot 12, and the sleep-sack zip in
      Shot 14 — record that zip as a wild sound three or four times
    ...
    - >-
      ...
      sounds ~-12 dBFS, loudness normalized to -14 LUFS on the
      deliver page. 2-frame audio crossfades on every cut; 2-second
      audio fade with the final fade to black.
music: >-
  This is the film where the music should be made by visible-feeling
  hands: solo fingerstyle acoustic guitar, or plucked piano-and-guitar
  duet — you want to HEAR fingertips on strings, fret squeaks left in,
  because a film about hands scored by hands closes a loop the audience
  feels without naming. Slow (60–70 BPM), major key with room for one
  wistful suspension, instrumental only. License-safe routes as ever:
  YouTube Audio Library (filter "Calm" — there's a deep bench of solo
  guitar), or an Artlist/Musicbed personal license if you want the
  boutique fingerstyle catalogs. Avoid anything strummed — strumming is
  weather, plucking is touch, and this film is about touch. Pick the
  track before the fine cut and let the batting sequence sit in a
  sparse stretch so the rattle hit owns its moment.
---
...
If week one was a wide film about a house and week eight was a brave film
about a day, this is a close film about ten square centimetres. Almost every
frame is skin: the look leans entirely on texture — knuckle creases, fat
wrist-rolls, fur, water, terry cloth — which changes the grade's priorities.
Skin protection is the star node, grain matters double (macro flesh without
...
sticks doing nothing but whispering edges from the floor — behind the lamp
in the glider corner, along a sleeping arm at the desk. Palette per the
...
**The menu rule, always: fifteen shots is the menu, not the contract.** This
film is unusually forgiving — most shots need one calm alert window and one
patch of window light, and week nine hands out three or four alert windows
a day. The film can be shot in five relaxed days.

**Batch by light and location, not shot number.**
- *Mat-by-the-window mornings:* Shots 1, 2, 3, and 4 all live on the
...
- *Changing table + feeds:* Shot 6 is five patient attempts across the week
  ...
  Shot 7 is a nap on Dad's lap and ten minutes.
...
**The 85mm truth, posted on the fridge:** minimum focus is about 0.8m —
inside that it will never, ever focus, and no amount of leaning helps. Fill
...
4K24/1-50/S-Log3/ISO800/5600K base state between setups. The variable ND
lives on the 85mm this week — the backlit window shots are where it holds
f/2.8 without touching the shutter.
